...
//        scanf("%c", &reservaLote[10][10]->tipoAlojamento);
//        fflush(stdin);
//
//        switch(tolower(reservaLote->tipoAlojamento)){
//            case 't':
//                reservaLote->tipoAlojamento = 'T';
//                break;
//            case 'c':
//                reservaLote->tipoAlojamento = 'C';
//                break;
//            case 'a':
//                reservaLote->tipoAlojamento = 'A';
//                break;
//            default:
